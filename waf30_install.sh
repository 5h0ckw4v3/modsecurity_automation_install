...
# Script for modsecurity instalation on centos(7) servers without httpd service installed 

# allow http service on firewalld
echo "Configuring firewalld..................Please wait"
firewall-cmd --permanent --add-service=http > /tmp/waf_reports.log
echo "Done..........................................[OK]"
echo -e "******************************************\n" >> /tmp/waf_reports.log

# Reloading firewalld service
echo "Reloading firewalld....................Please wait"
firewall-cmd --reload >> /tmp/waf_reports.log
echo "Done..........................................[OK]"
echo -e "******************************************\n" >> /tmp/waf_reports.log
...
echo "Enabling and starting httpd service....Please wait"
systemctl start httpd.service && systemctl enable httpd.service 2>> /tmp/waf_reports.log | >> /tmp/waf_reports.log
echo "Done..........................................[OK]"
echo -e "******************************************\n" >> /tmp/waf_reports.log
